...
const interviewTopics = [
	...
	},
	{
		...
		bgColor: "from-blue-900/15 to-blue-800/15",
		link: "#",
	},
	{
		title: "System Design",
		...
		bgColor: "from-blue-900/25 to-blue-800/25",
		link: "#",
	},
	{
		title: "Programming",
...
export default function InterviewPreparation() {
	return (
		<section className="w-full py-16 md:py-20 px-4 md:px-8 flex flex-col items-center relative overflow-hidden">
			{/* Unified Background - matching main page gradient */}
			<div className="absolute inset-0 bg-gradient-to-b from-black via-blue-900 to-black"></div>

			{/* Animated Grid Pattern - simplified for consistency */}
